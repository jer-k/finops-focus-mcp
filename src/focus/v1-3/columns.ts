export type FocusColumn = {
  ...
  category: string;
  columnType: "Dimension" | "Metric" | "Dimension / Metric";
...
export const costAndUsageColumns: FocusColumn[] = [
  ...
  },
  {
    ...
    status: "Conditional",
    description:
      "Indicates whether the charge corresponds with the consumption of a commitment discount or the unused portion of the committed amount. Allowed values: Used, Unused.",
  },
  {
    ...
    dataType: "String",
    status: "Conditional",
    description: "A service-provider-assigned identifier for the type of commitment discount applied to the row.",
  },
  {
